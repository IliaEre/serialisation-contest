...
func (rcv *Address) Apartment() []byte {
...
func AddressAddCode(builder *flatbuffers.Builder, code flatbuffers.UOffsetT) {
...
func AddressAddStreet(builder *flatbuffers.Builder, street flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(2, flatbuffers.UOffsetT(street), 0)
}
func AddressAddApartment(builder *flatbuffers.Builder, apartment flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(3, flatbuffers.UOffsetT(apartment), 0)
}
